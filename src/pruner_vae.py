...
from nni.compression.pytorch.pruning import L2NormPruner, L1NormPruner,FPGMPruner
...
config_list =  [{ 'sparsity': 0.5, 'op_types': ['Linear']},{'exclude': True, 'op_names': ['fc4']}]
# config_list =  [{ 'sparsity': 0.2, 'op_types': ['Linear']},{'exclude': True, 'op_names': ['fc4']}]
# config_list =  [{ 'sparsity': 0.8, 'op_types': ['Linear']},{'exclude': True, 'op_names': ['fc4']}]
